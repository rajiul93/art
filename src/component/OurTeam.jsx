	...
	<div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
		...
		<div className="flex flex-row flex-wrap-reverse justify-center">
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="dark:text-gray-600">An Oil Painting Designer</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
				<p className="dark:text-gray-600">Charcoal sketching Designer</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
				<p className="dark:text-gray-600">Cartoon drawing  Designer</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
				<p className="dark:text-gray-600">Watercolor Painting Designer</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
				<p className="dark:text-gray-600">Portrait Drawing  Designer</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
				<p className="dark:text-gray-600">Landscape Painting Designer</p>
			</div>
		</div>
	</div>
</section>
